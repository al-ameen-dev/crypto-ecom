...
from .views import ProductList, ProductCategory, ProductCategoryPrice, ProductSearch, UserCart, Userprofile
...
urlpatterns = [
    ...
    path('userinfo',Userprofile.as_view(),name='user-profile'),
